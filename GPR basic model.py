...
list_x1 = []
for x in range(105):
    list_x1.append(random.uniform(0,1))
list_x2 = []
for x in range(105):
    list_x2.append(random.uniform(0,1))
...
mu,sigma = 0,1
random.seed(1)
s = np.random.normal(mu,sigma,105)
...
new_list = list(chain(final_list[0:100]))
test_list = list(chain(final_list[100:105]))
