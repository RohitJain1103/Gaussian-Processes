...
for (a,b) in temp_list:
    y_temp = alpha0 + alpha1*a + alpha2*pow(a,2) + alpha3*pow(a,5) + alpha4*pow(a,6)
...
list1_x1 = []
for x in range(50):
    list1_x1.append(random.uniform(-1100,-1000)+1100)
#list1_x1 = list1_x1-300
list1_x2 = []
for x in range(50):
    list1_x2.append(random.uniform(-1100,-1000)+1100)
...
for (a,b) in temp_list1:
    y_temp1 = alpha0 + alpha1*a + alpha2*pow(a,2) + alpha3*pow(a,5) + alpha4*pow(a,6)
